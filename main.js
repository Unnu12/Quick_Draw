...
document.getElementById("sketch-name").innerHTML = "Sketch to be drawn: " +element_of_array;
...
function check_sketch(){
    ...
    if(timer_counter > 500){
        ...
        document.getElementById("conidence").innerHTML = "Confidence:";
        timer_counter = 0;
...
function gotResults(error , results){
    ...
    document.getElementById("conidence").innerHTML = "Confidence: "+ Math.round(results[0].confidence * 100) + "%";
}